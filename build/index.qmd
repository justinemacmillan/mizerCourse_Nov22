...
3.  [**Refine your model: landings data**](refine-landings.qmd)\
    In this tutorial we will use an R shiny application to explore how changes in parameters will affect model behaviour and to adjust it to agree with landings data, in particular the size distribution of the landings.
    
4.  [**Refine your model: diet data**](refine-diet.qmd)\
    In this tutorial we will explore how the diet emerges in the model from the interplay between predation preference and prey abundance and adjust the model parameters to reproduce observed diets. 
