...
data_sp<- left_join(data_sp, ices_areas, by = ('ices_area' = 'ices_area'))|>
...
data_sp<- left_join(data_sp, species_codes, by = c('species' = 'code_ices') )|> filter (species != 'cod. '& ices_area != '27.5a' )|>select(Species,  biomass_observed, yield_observed)|>rename('species' = 'Species')
