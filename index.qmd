...
The course is led by [Gustav Delius](https://orcid.org/0000-0003-4092-8228) (University of York, UK). Invited speakers include [Ken Haste Andersen](https://ken.haste.dk/) and [Julia Blanchard](https://www.utas.edu.au/profiles/staff/imas/julia-blanchard). The course is based on an earlier version created in collaboration with Asta Audzijonyte (Nature Research Centre, Lithuania & University of Tasmania, Australia). [Kennedy Osuka (University of York)](https://www.york.ac.uk/maths/staff/kennedyosukaedeye/) has worked on updating the course materials to use the Celtic Sea as the example ecosystem.
